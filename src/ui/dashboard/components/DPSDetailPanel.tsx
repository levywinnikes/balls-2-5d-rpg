          ...
          <div className="p-3 border-b border-white/5 flex items-center justify-between bg-white/5">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-white/60 uppercase font-bold tracking-widest">
                {t("panel_base_damage" as any)}
              </span>
            </div>
            <span className="text-xs font-mono text-white/30">
              1 - {breakdown.maxAttack}
            </span>
          </div>
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="flex justify-between items-center group">
              <div className="flex flex-col">
                <span className="text-xs text-white/80 font-semibold italic">
                  {t("panel_normal_average" as any)}
                </span>
                <span className="text-[9px] text-white/30 uppercase tracking-tighter">
                  {t("panel_no_critical_hits" as any)}
                </span>
              </div>
              <div className="text-xl font-bold text-white">
                {breakdown.avgNormalDmg}
              </div>
            </div>
            ...
            <div className="space-y-2 pt-2 border-t border-white/5">
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs text-yellow-400/90 font-semibold italic">
                    {t("panel_critical_bonus" as any)}
                  </span>
                </div>
                <span className="text-md font-bold text-yellow-500">
                  +
                  {(
                    (breakdown.avgCritDmg - breakdown.avgNormalDmg) *
                    (breakdown.critChance / 100)
                  ).toFixed(1)}
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 mt-1">
                <div className="bg-black/40 p-2 rounded border border-white/5">
                  <div className="text-[8px] text-white/30 uppercase tracking-widest mb-0.5">
                    {t("panel_chance" as any)}
                  </div>
                  <div className="text-xs font-bold text-white/90">
                    {breakdown.critChance.toFixed(1)}%
                  </div>
                  <div className="text-[8px] text-white/20 mt-0.5">
                    {t("stats.dexterity" as any)} {breakdown.dexterity}
                  </div>
                </div>
                <div className="bg-black/40 p-2 rounded border border-white/5">
                  <div className="text-[8px] text-white/30 uppercase tracking-widest mb-0.5">
                    {t("panel_multiplier" as any)}
                  </div>
                  <div className="text-xs font-bold text-white/90">
                    +{breakdown.critMultiplier.toFixed(0)}%
                  </div>
                  <div className="text-[8px] text-white/20 mt-0.5">
                    {t("stats.strength" as any)} {breakdown.strength}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="pt-3 border-t border-white/10 flex justify-between items-center">
              <span className="text-xs font-bold text-blue-300 uppercase tracking-widest">
                {t("panel_total_damage_per_hit" as any)}
              </span>
          ...
          <div className="bg-purple-500/10 rounded-xl border border-purple-500/20 p-4 flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[9px] text-purple-400/60 uppercase tracking-tighter">
                  {t("panel_global_stat_multiplier" as any)}
                </div>
              </div>
            </div>

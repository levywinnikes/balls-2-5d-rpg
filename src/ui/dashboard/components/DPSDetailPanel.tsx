    ...
    return (
        <div className="h-full flex flex-col bg-black/60 rounded-xl p-4 border border-white/10">
            ...
            <div className="border-b border-white/10 pb-3 mb-4">
                ...
                <div className="text-lg font-bold text-white mt-1">DPS (Dano por Segundo)</div>
            </div>

            {/* Total Value */}
            <div className="text-center py-6 bg-blue-500/10 rounded-lg border border-blue-500/20 mb-4">
                <div className="text-[10px] text-white/40 uppercase tracking-widest mb-2">Total DPS</div>
            ...
            <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar space-y-4">
                ...
                <div className="bg-white/5 rounded-xl border border-white/10 overflow-hidden">
                    <div className="p-3 border-b border-white/5 flex items-center justify-between bg-white/5">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] text-white/60 uppercase font-bold tracking-widest">Base de Dano</span>
                        </div>
                    ...
                    <div className="p-4 space-y-4">
                        ...
                        <div className="flex justify-between items-center group">
                            <div className="flex flex-col">
                                <span className="text-xs text-white/80 font-semibold italic">Média Normal</span>
                                <span className="text-[9px] text-white/30 uppercase tracking-tighter">Sem considerar acertos críticos</span>
                            </div>
                        ...
                        <div className="space-y-2 pt-2 border-t border-white/5">
                            <div className="flex justify-between items-center">
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-xs text-yellow-400/90 font-semibold italic">Bônus Crítico</span>
                                </div>
                            ...
                            <div className="grid grid-cols-2 gap-2 mt-1">
                                <div className="bg-black/40 p-2 rounded border border-white/5">
                                    <div className="text-[8px] text-white/30 uppercase tracking-widest mb-0.5">Chance</div>
                                    <div className="text-xs font-bold text-white/90">{breakdown.critChance.toFixed(1)}%</div>
                                    <div className="text-[8px] text-white/20 mt-0.5">Dex {breakdown.dexterity}</div>
                                </div>
                                <div className="bg-black/40 p-2 rounded border border-white/5">
                                    <div className="text-[8px] text-white/30 uppercase tracking-widest mb-0.5">Multiplicador</div>
                                    <div className="text-xs font-bold text-white/90">+{breakdown.critMultiplier.toFixed(0)}%</div>
                                    <div className="text-[8px] text-white/20 mt-0.5">Str {breakdown.strength}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="pt-3 border-t border-white/10 flex justify-between items-center">
                            <span className="text-xs font-bold text-blue-300 uppercase tracking-widest">Dano Total / Golpe</span>
                ...
                <div className="bg-white/5 rounded-xl border border-white/10 p-4 flex justify-between items-center hover:bg-white/10 transition-colors">
                    <div className="flex flex-col">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs text-white/80 font-bold uppercase tracking-widest">Frequência</span>
                        </div>
                        <span className="text-[9px] text-white/30 uppercase tracking-tighter mt-1">Multiplicador de Ataques por Segundo</span>
                    </div>
                ...
                {breakdown.willpowerBonus > 0 && (
                    <div className="bg-purple-500/10 rounded-xl border border-purple-500/20 p-4 flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="text-xs text-purple-300 font-bold uppercase tracking-widest">Força de Vontade</div>
                                <div className="text-[9px] text-purple-400/60 uppercase tracking-tighter">Multiplicador Global de Stats</div>
                            </div>
                        </div>
                ...
                <div className="py-2 px-1 opacity-40">
                    <div className="text-[9px] font-mono text-center leading-relaxed text-white/60">
                        DPS = ((Média Normal) + (Bônus Crítico)) × APS
                    </div>
                </div>

...
export class RedRoofRightGraphic {
  static readonly TEXTURE_KEY = "red-roof-right-texture";
  ...
  private static readonly TEXTURE_PATH = "assets/tiles/roof/redroofright.png";

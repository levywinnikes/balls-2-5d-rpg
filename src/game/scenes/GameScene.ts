  ...
  async create(): Promise<void> {
    ...
    try {
      ...
      */
      ...
      if (initData?.benchmarkMode) {
        const config: BenchmarkConfig = {
          benchmarkName: initData.benchmarkName || "Benchmark",
          benchmarkAutoClose: !!initData.benchmarkAutoClose,
          benchmarkReportPath:
            typeof initData.benchmarkReportPath === "string"
              ? initData.benchmarkReportPath
              : null,
        };
        this.benchmarkRunner = new BenchmarkRunner(this, config, {
          ...
          getNearbyItems: (distance: number) => this.getNearbyItems(distance),

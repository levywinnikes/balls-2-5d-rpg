...
2. Define impacted modules and required validations using the matrix.
3. Implement the smallest safe change.
4. Run required validations.
5. Update contracts/docs if any rule or behavior changed.
6. Summarize scope, validations, and residual risk in the task output.

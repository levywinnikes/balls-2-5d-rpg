...
- **Graphic Architecture**: 100% Procedural runtime generation (Phaser Graphics). External image textures for tiles/entities are **strictly forbidden**. All visuals must be generated at runtime via `BaseTileGraphic.drawTile()` or equivalent.
...
- **Enemy Size**: Base 32×32. Boss types may use larger procedural canvases (e.g. Dragon: 64×64).

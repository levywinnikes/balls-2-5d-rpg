...
Run `npm run benchmark:e2e` only when at least one trigger applies:

- PR-final validation
- release candidate validation
- benchmark harness/checkpoint/menu benchmark flow changes
- explicit user request for full E2E benchmark

...
title Balls 2.5D - Debug Forest

echo.
echo  ========================================
echo   Balls 2.5D - Debug Forest (props 3D)
echo  ========================================
echo.
...
echo [1/3] Gerando mapa debug_forest...
call npm run generate:debug-forest
if errorlevel 1 (
...
set "PLAY_URL=http://localhost:4000/?map=debug_forest&autostart=1"
...
echo.
echo  Pronto! Mapa: debug_forest (arvores + flores animadas)
echo  URL: %PLAY_URL%
echo.
echo  Debug props: window.__slice3dProps
echo.
pause
exit /b 0

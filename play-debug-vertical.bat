...
title Balls 2.5D - Debug Vertical

echo.
echo  ========================================
echo   Balls 2.5D - Debug Vertical World
echo  ========================================
echo.
...
echo [1/3] Gerando mapa debug_vertical...
call npm run generate:debug-vertical
if errorlevel 1 (
...
echo.
echo  Pronto! Mapa: debug_vertical (5 andares: -2 a +2)
echo  URL: %PLAY_URL%
echo.
echo  Debug visibilidade: window.__slice3dVerticalVisibility
echo.
pause
exit /b 0
